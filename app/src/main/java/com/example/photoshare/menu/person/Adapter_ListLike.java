...
public class Adapter_ListLike extends RecyclerView.Adapter<Adapter_ListLike.photoViewHolder> {
    private final Context context;
    private final List<Entity_Photo> photoList;

    public Adapter_ListLike(Context context, List<Entity_Photo> photoList) {
    ...
    public photoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.item_person_list_like, null);
