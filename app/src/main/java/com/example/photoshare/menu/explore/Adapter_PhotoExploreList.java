...
public class Adapter_PhotoExploreList extends ArrayAdapter<Entity_Photo> {
    ...
    public Adapter_PhotoExploreList(Context context, int resourceId, List<Entity_Photo> data) {
