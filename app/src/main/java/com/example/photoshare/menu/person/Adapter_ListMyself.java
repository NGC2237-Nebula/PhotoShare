...
public class Adapter_ListMyself extends ArrayAdapter<Entity_Photo> {
    ...
    public Adapter_ListMyself(Context context, int resourceId, List<Entity_Photo> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load(photoUrl).into(viewHolder.ivImage);
